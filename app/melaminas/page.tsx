              ...
              <div className="md:col-span-2">
                ...
                <div className="flex items-center gap-4">
                  {form.foto_url && !imagenFile && (
                    <img src={form.foto_url} alt="Vista previa" className="w-16 h-16 object-cover rounded-2xl border shadow-xs" />
                  )}
                  <input type="file" accept="image/*" onChange={e => e.target.files && setImagenFile(e.target.files[0])} className="w-full text-xs text-gray-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-[#001f3f]/5 file:text-[#001f3f] hover:file:bg-[#001f3f]/10 cursor-pointer" />
                </div>
              </div>
            </div>
